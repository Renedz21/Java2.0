...
import Fuerzas_aceleracion.Fuerza_centripeta1;

/**
 *
 * @author Microsoft
 */
public class Centripeta1 extends javax.swing.JFrame {

    /**
     * Creates new form Centripeta1
     */
    public Centripeta1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Velocidad lineal [v]");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Fuerza_centripeta1 obj = new Fuerza_centripeta1(a,b,c);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Centripeta1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Centripeta1().setVisible(true);
            }
        });
    }
